...
function generateColor(): { r: number; g: number; b: number } {
    // Green color palette
    const colors = [
        { r: 0, g: 150, b: 50 },    // forest green
        { r: 50, g: 200, b: 80 },   // bright green
        { r: 20, g: 120, b: 40 },   // dark green
        { r: 80, g: 180, b: 100 },  // lime green
    ];
    
    // Pick a random base color from your palette
    const baseColor = colors[Math.floor(Math.random() * colors.length)];
    
    // Much smaller variation to stay strictly on theme
    const variation = 0.1; // Reduced from 0.3 to 0.1 for tighter color control
    const brightnessMultiplier = 0.08; // Reduced for more gas-like appearance
